...
export const addToCart = (product_id, size, quantity) => api.post("/cart/items", { product_id, size, quantity });
export const updateCartItem = (product_id, data) => api.put(`/cart/items/${product_id}`, data);
export const removeFromCart = (product_id) => api.delete(`/cart/items/${product_id}`);
export const clearCart = () => api.delete("/cart");

// Shipping
export const calculateShipping = (zip_code, items) => api.post("/shipping/calculate", { zip_code, items });
export const validateCEP = (zip_code) => api.post("/shipping/validate-cep", { zip_code });
...
export const getSalesReport = (days) => api.get("/admin/reports/sales", { params: { days } });
